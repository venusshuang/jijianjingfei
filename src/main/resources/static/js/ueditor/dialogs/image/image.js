...
(function () {
    ...
    function insertBatch() {
        ...
        for (var i = 0, ci; ci = imageUrls[i++];) {
            ...
            tmpObj._src = tmpObj.src = "/" + imgpath;//虚拟地址update2013-7-17
            imgObjs.push(tmpObj);
        }
        insertImage(imgObjs);
        hideFlash();
                        ...
                        ajax.request(editor.options.imageManagerUrl, {
                            ...
                            onsuccess:function (xhr) {
                                ...
                                for (var k = 0, ci; ci = imageUrls[k++];) {
                                    ...
                                    //alert(editor.options.imageManagerPath);
                                    //var sp=editor.options.imageManagerPath;
                                    //sp=sp.replace("/ueditor/jsp","");
                                    var sp="/";
                                    img.setAttribute(k < 35 ? "src" : "lazy_src", sp + ci.replace(/\s+|\s+/ig, ""));
                                    img.setAttribute("_src", sp + ci.replace(/\s+|\s+/ig, ""));
